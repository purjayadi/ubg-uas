...
@section('title', 'Tambah Restoran - RevResto')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Tambah Restoran Baru</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('restaurants.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" required value="{{ old('address') }}" id="inputAddress">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="cuisine_type" class="form-control @error('cuisine_type') is-invalid @enderror" required value="{{ old('cuisine_type') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="latitude" class="form-control @error('latitude') is-invalid @enderror" step="0.00000001" placeholder="Contoh: -6.200000" value="{{ old('latitude') }}" id="inputLatitude">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="longitude" class="form-control @error('longitude') is-invalid @enderror" step="0.00000001" placeholder="Contoh: 106.816666" value="{{ old('longitude') }}" id="inputLongitude">
...
{{-- 
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('restaurants.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
